...
var SecondaryToolbar = {
  ...
  initialize: function secondaryToolbarInitialize(options) {
    ...
    this.favourite = options.favourite;
    ...
    var elements = [
      ...
      // (except for toggleHandTool, hand_tool.js is responsible for it):
      {
        ...
        element: this.favourite,
        handler: this.favouriteClick
      }, {
        element: this.print,
  ...
  favouriteClick: function secondaryToolbarFavouriteClick(evt) {
...
var PDFViewerApplication = {
  ...
  initialize: function pdfViewInitialize() {
    ...
    SecondaryToolbar.initialize({
      ...
      favourite: document.getElementById('secondaryOpenFile'),
  ...
  open: function pdfViewOpen(file, scale, password,
    ...
    PDFJS.getDocument(parameters, pdfDataRangeTransport, passwordNeeded,
      ...
      function getDocumentError(exception) {
        /***
         * delete error document so it can downloaded again
         **/
        var remote = require('electron').remote,
          fs = remote.require('fs');
        fs.unlinkSync(PDFJS.file);
...
function webViewerInitialized() {
  ...
  //id
  PDFJS.documentId = 'id' in params ? params.id : 0;
  //file
  PDFJS.file = file;
  ...
  //favourite
  var favourite;
  if ('favourite' in params) {
    favourite = params['favourite'];
  }
  var favouriteClassName = favourite === 'true' ? 'favourite' : 'unfavourite';
  // document.getElementById('favouriteBtn').className = 'toolbarButton hiddenLargeView ' + favouriteClassName;
  document.getElementById('secondaryOpenFile').className = 'secondaryToolbarButton visibleLargeView ' + favouriteClassName;
  ...
  // document.getElementById('favouriteBtn').addEventListener('click', addOrRemoveFavourites);
...
function addOrRemoveFavourites(e) {
  var remote = require('electron').remote,
    scule = remote.require('./js/com.scule'),
    localization = remote.require('./js/localization'),
    strings = localization.getStrings(),
    pdfFilesColl = scule.factoryCollection('scule+nodejs://' + strings.lang + '_pdfFiles'),
    favouritesColl = scule.factoryCollection('scule+nodejs://' + strings.lang + '_favourites'),
    favourite = favouritesColl.find({
      id: PDFJS.documentId
    }).length !== 0;
  if (favourite) {
    favouritesColl.remove({
      id: PDFJS.documentId
    });
  } else {
    favouritesColl.save(pdfFilesColl.find({
      id: PDFJS.documentId
    })[0]);
  }
  var favouriteClassName = favourite ? 'unfavourite' : 'favourite';
  // document.getElementById('favouriteBtn').className = 'toolbarButton hiddenLargeView ' + favouriteClassName;
  document.getElementById('secondaryOpenFile').className = 'secondaryToolbarButton visibleLargeView ' + favouriteClassName;
  favouritesColl.commit();
}
